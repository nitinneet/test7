...
class MockSetInterfaceForUserPlane final : public
SetInterfaceForUserPlane::Service { 
	public : MockSetInterfaceForUserPlane() : SetInterfaceForUserPlane::Service() {}
	MOCK_METHOD3(SetUPFNodeState, Status(grpc::ServerContext*, const UPFNodeState*,
...
TEST_F(SetUPFNodeState, test_upf_node_state) {
  ...
  ON_CALL(*set_interface_for_up_mock, SetUPFNodeState(_, _, _)).WillByDefault(Return(Status::OK));
